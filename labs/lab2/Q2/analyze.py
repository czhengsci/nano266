...
patterns = {
    ...
    "lattice_parameter":re.compile('alat\)\s+\=\s+([\d\.]+)')
}
...
def analyze(filenames):
    fieldnames = ['filename', 'ecut', 'nkpts', 'alat',
                  'energy','total_force','cpu_time','lattice_parameter']
    with open('results_cpu.csv', 'w') as csvfile:
